...
const ListItem = ({ id, music, name }) => {
  return (
    <div className="group flex flew-wrap w-5/6 items-center justify-between h-auto bg-white shadow-lg rounded-full m-2 p-1 ">
      ...
      <button
        id="playButton"
        type="button"
        className="flex w-8 h-8 mr-2"
        onClick={() => insertVideo(music)}
      >
        <img
